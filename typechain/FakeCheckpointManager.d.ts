...
interface FakeCheckpointManagerInterface extends ethers.utils.Interface {
  functions: {
...
export class FakeCheckpointManager extends BaseContract {
  ...
  interface: FakeCheckpointManagerInterface;
